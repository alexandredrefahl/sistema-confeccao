...
function FormBarraPeca(props) {
  ...
  const tab1 = [
    ...
    {
      tamanho: 4,
      label: "Tipo de Barra para Peças",
      name: "BarraPeca",
      qualComponente: "text",
      value: obj["BarraPeca"],
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Tab label="Cadastro de Tipos de Barras para Peças" />
        </Tabs>
        <Divider />
        <TabPanel value={value} index={0}>
          <Grid container spacing={2} sx={{ p: 1 }}>
            <Grid item xs={12}>
              <b>Cadastro de Tipos de Barra para Peças</b>
            </Grid>
            {tab1.map((item, index) => (
