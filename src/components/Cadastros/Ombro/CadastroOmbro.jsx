...
import objOmbro from "../../objetosParaRequest/objOmbro";
import Form from "./FormOmbro";

function CadastroOmbro() {
  const [obj, setObj] = useContext(Context);

  const [oQueMostrar, setOqueMostrar] = useState("tabela");

  const qualTabelaUsar = "cadOmbro";
          ...
          <Grid item xs={12} sx={{ p: 1 }}>
            <DataTableMui
              ...
              columns={[
                ...
                {
                  field: "Ombro",
                  headerName: "Tipos de Ombros",
                  flex: 9 / 10,
                },
              ]}
              tableReaderArgs={{
                tabela: qualTabelaUsar,
                escolhaDeColunas: "id, Ombro",
                ordenar: "id",
              }}
            />
          </Grid>
