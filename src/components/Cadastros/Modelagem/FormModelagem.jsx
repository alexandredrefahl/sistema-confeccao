  ...
  return (
    <>
      ...
      >
        ...
        >
          <Tab label="Cadastro de Modelagens" />
        </Tabs>
        <Divider />
        <TabPanel value={value} index={0}>
          <Grid container spacing={2} sx={{ p: 1 }}>
            <Grid item xs={12}>
              <b>Cadastro de Modelagens</b>
            </Grid>
            {tab1.map((item, index) => (
