...
function FormCompPeca(props) {
  ...
  const tab1 = [
    ...
    {
      tamanho: 4,
      label: "Tipo de Comprimento para Peças",
      name: "CompPeca",
      qualComponente: "text",
      value: obj["CompPeca"],
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Tab label="Cadastro de Comprimentos para Peças" />
        </Tabs>
        <Divider />
        <TabPanel value={value} index={0}>
          <Grid container spacing={2} sx={{ p: 1 }}>
            <Grid item xs={12}>
              <b>Cadastro de Comprimentos para Peças</b>
            </Grid>
            {tab1.map((item, index) => (
