...
function FormBarraManga(props) {
  ...
  const tab1 = [
    ...
    {
      tamanho: 4,
      label: "Tipo de Barra para Mangas",
      name: "BarraManga",
      qualComponente: "text",
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Tab label="Cadastro de Tipos de Barras para Mangas" />
        </Tabs>
        <Divider />
        <TabPanel value={value} index={0}>
          <Grid container spacing={2} sx={{ p: 1 }}>
            <Grid item xs={12}>
              <b>Cadastro de Tipos de Barra para Mangas</b>
            </Grid>
            {tab1.map((item, index) => (
