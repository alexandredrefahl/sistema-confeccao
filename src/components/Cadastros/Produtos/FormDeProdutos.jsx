...
function FormDeProdutos(props) {
		...
		obj['produtosFilhos'].forEach((produto, index) => {
			arrTemporaria.push(
				...
				},
				{
					...
					qualComponente: 'text',
					type: 'text',
					value: obj['produtosFilhos'][index]['codBarras'],
					handleChangeProp: (e) =>
						handleChangeProdutoFilho(e, index, 'codBarras'),
				},
				{
					tamanho: 12,
					qualComponente: 'divider',
	...
	const preenche_nomes_iguais = () => {
		console.log('Evento OnBLur no input Nome');
		// console.log('Input Nome lost focus:');
		// You can perform any actions here when the input loses focus
		// setObj((prevObj) => ({
		// 	...prevObj,
		// 	['nomeSite']: obj['nome'],
		// 	['nomeEncomenda']: obj['nome'],
		// }));
	};
	...
	const dadosGerais = [
		...
		},
		{
			...
			type: 'text',
			value: obj['nome'],
			handleBlur: preenche_nomes_iguais(),
			handleChangeProp: (e) => handleChange(e, setObj),
			maxLength: 60,
		},
		{
